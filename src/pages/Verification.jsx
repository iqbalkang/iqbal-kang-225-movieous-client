...
const Verification = () => {
  ...
  return (
    <VerticalContainer>
      <div className='dark:bg-background p-8 shadow'>
        <div>
        ...
        <div className='flex gap-4 justify-center my-6'>
          {otp.map((_, index) => {
            return (
              <input
                key={index}
                className='appearance-none w-10 h-10 text-center rounded bg-transparent border border-grayish outline-none focus:border-black focus:dark:border-white duration-200'
                type='number'
                value={otp[index]}
